    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return fetch('http://localhost:3000/api/v1/user/login', options);
        case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return fetch('http://localhost:3000/api/v1/user/logout', options);
        case 5:
        ...
        case 11:
          ...
          console.log(_data2);
          console.log(_data2);
          if (_data2 === 'success') location.reload(true);
          _context2.next = 20;
          break;
        case 17:
          _context2.prev = 17;
          _context2.t0 = _context2["catch"](0);
          (0, _alert.showAlert)('error', 'error in logout');
        case 20:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          console.log(data);
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/user/updatepassword' : 'http://127.0.0.1:3000/api/v1/user/updateMe';
          console.log(url);
          _context.next = 7;
          return fetch(url, {
            method: 'PATCH',
        ...
        case 18:
          ...
          (0, _alert.showAlert)('error', 'An error occurred while updating settings');
        case 22:
        case "end":
          return _context.stop();
      }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var loginForm = document.querySelector('.piko');
